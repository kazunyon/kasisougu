...
(async () => {
  ...
  const searchUrl = new URL(run("nearbyMapsSearchUrl({address:'さいたま市見沼区堀崎町1592'})"));
  ...
  console.log('PASS: distance, pagination, candidate merge, selectable destination URL, encoding, empty/error states, and no paid Maps API.');
