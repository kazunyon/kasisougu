...
cache_files = ['index.html', 'style.css', 's03-s04.css', 'f04-f05.css', 'redesign.css', 'pages-config.js', 'app.js', 'catalog.js', 'records.js', 'consultation.js', 'nearby-search.js', 'invitation.html', 'invitation.js', 'manifest.webmanifest', 'brand-logo.png', 'icon-192.png', 'icon-512.png']
...
const FILES = ['./', './index.html', './style.css', './s03-s04.css', './f04-f05.css', './redesign.css', './pages-config.js', './app.js', './catalog.js', './records.js', './consultation.js', './nearby-search.js', './invitation.html', './invitation.js', './manifest.webmanifest', './brand-logo.png', './icon-192.png', './icon-512.png'];
