...
(target / 'sw.js').write_text('''const CACHE = 'kasisougu-pages-shell-v2';
const FILES = ['./', './index.html', './style.css', './s03-s04.css', './pages-config.js', './app.js', './manifest.webmanifest', './icon-192.png', './icon-512.png'];
