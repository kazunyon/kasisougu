...
(target / 'sw.js').write_text('''const CACHE = 'kasisougu-pages-shell-v6';
const FILES = ['./', './index.html', './style.css', './s03-s04.css', './f04-f05.css', './redesign.css', './pages-config.js', './app.js', './catalog.js', './records.js', './consultation.js', './manifest.webmanifest', './icon-192.png', './icon-512.png'];
