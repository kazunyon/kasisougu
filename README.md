...
「装具びより」は、下肢装具を使っている方が、ご自身の装具や日々の記録、相談したいことを整理するためのアプリです。また、「どこへ行けば相談やアドバイスを受けられるのか分からない」という方のために、住所と探したい目的を入力して、リハビリ施設や義肢装具店などを地図で探せる機能も用意しています。
...
新規利用は招待制です。運営担当者から受け取った6桁キーを使って招待を申し込み、届いた招待メールのリンクからパスワードを設定してください。メール新規登録を直接行うことはできません。運営者向けの導入・鍵の設定手順は[招待登録の設定](docs/invitation-registration.md)を参照してください。
