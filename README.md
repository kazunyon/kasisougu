...
「近くで探す」には、2つの探し方があります。

### 登録施設から探す

登録住所または現在地をもとに、アプリに登録されている施設を直線距離の近い順で確認できます。目的や距離で絞り込むこともできます。

直線距離は、実際の道路距離や移動時間とは異なります。受診や訪問の前に、対応内容、診療時間、予約の要否、交通手段、バリアフリー設備などを施設へ直接ご確認ください。

### Google Mapsで探す

登録住所、別の住所、または許可後に取得した現在地を使い、目的に合った検索をGoogle Mapsで開けます。検索結果や経路、口コミなどはGoogle Maps上で確認します。

現在地は保存しません。住所検索の精度により、表示される位置や距離に誤差が生じることがあります。見つけた施設は、ご自身用の候補としてアプリへ登録し、後から編集・削除できます。
