...
都道府県を選ぶと、ブラウザから読める全国住所データで該当都道府県の全市区町村候補を読み込みます。移動手段（車・公共交通・福祉タクシー・電動車いす）、移動可能時間（30・60・90分）、目的（装具の製作・修理・適合確認・リハビリ・制度相談）を選ぶと、Google Maps PlatformのPlaces検索と経路検索で候補を絞り、最大5件を表示します。アプリ内には施設マスタを保存しません。
