...
「Supabase に接続できませんでした」と表示される場合は、ブラウザーの拡張機能や通信フィルターが `https://zvuknqikqbumoswbhjau.supabase.co` を遮断していないか確認してください。シークレットウィンドウなど、拡張機能が動作しない状態で同じ画面を開くと、切り分けに役立ちます。パスワードをこの手順書や問い合わせ文へ書かないでください。
