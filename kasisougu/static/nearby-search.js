...
function nearbyMapsSearchUrl(center) { const origin = center.address || center.routeOrigin || `${center.lat},${center.lng}`; return `https://www.google.com/maps/dir/?${new URLSearchParams({api:'1',origin,travelmode:'walking'}).toString()}`; }
